...
After all of the organizations in your network have created nodes on the new platform, and you have used the tool to migrate your chaincode, you can use the {{site.data.keyword.blockchainfull_notm}} Platform 2.0 console to download a new connection profile. The {{site.data.keyword.blockchainfull_notm}} Platform 2.0 connection profile can be downloaded from the **Organization MSP** tile on the **Organizations** panel. You can use the connection profile for all of your channels if you joined the same peers to each channel. For more information, see [Connect with SDK](/docs/blockchain/reference?topic=blockchain-ibp-console-smart-contracts-14#ibp-console-smart-contracts-connect-to-SDK-panel). Chaincode is referred to as smart contracts on the {{site.data.keyword.blockchainfull_notm}} Platform 2.0 console UI.
