...
|:-|:-----------------|:-----------------|:-----------------|
| **Goal:** Larger peers for more robust integration testing. <br><br> You can join the peers to multiple channels to better simulate a real environment or put them all in one account. | <ul><li>2-3 organizations</li><li>CouchDB</li><li>Bronze Storage</li><li>No: HA, Backup, HSM, LogDNA, SysDig, Dedicated VM/HW</li></ul> | Includes: <br>**Single node Raft ordering service**<ul><li>0.35GB VPC/0.7GB RAM/100GB Storage</li></ul><br>**2 CAs**<ul><li>2 x (0.1 VPC/0.2GB RAM/20 GB Storage) = <br>0.2 VPC/0.4GB RAM/40 GB Storage</li></ul><br>**1 Peer**<ul><li> **Peer container:** 0.2 VPC/0.4GB RAM/25GB Storage</li><li>**Couch container:** 0.2 VPC/0.4GB RAM/25GB Storage</li><li>**Smart contract container:** 0.5 VPC/1GB RAM/0GB Storage</li><li> **Logging/gRPC Web container:** 0.2 VPC/0.4GB RAM/0GB Storage</li></li></ul> |  Includes: <br>**1 CA**<ul><li> 0.1 VPC/0.2GB RAM/20 GB Storage</li> </ul>**1 Peer**<ul><li> **Peer container:** 0.2 VPC/0.4GB RAM/25GB Storage</li><li> **CouchDB container:** 0.2 VPC/0.4GB RAM/25GB Storage</li><li> **Smart contract container:** 0.5 VPC/1GB RAM/0GB Storage</li><li>**Logging/gRPC Web container:** 0.2 VPC/0.4GB RAM/0GB Storage</li></li></ul>|
...
| **Total Resources** |  | **VPC:** 9.6<br> **RAM:** 13.4GB<br> **Storage:** 4040GB|  **VPC:** 4.5GB<br> **RAM:** 8.2GB<br> **Storage:** 1520GB|
...
| **Optional upgrades** | | **HA CA (PostgreSQL):** +$40 USD/month <br><br> **HSM:** +$906 USD/month <br><br> **Silver Storage:**+$224 USD/month <br><br>**IKS MZR 2 zone:** +$1,152 USD/month|**HA CA (PostgreSQL):** +$40 USD/month <br><br> **HSM:** +$906 USD/month <br><br> **Silver Storage:**+$105 USD/month <br><br>**IKS MZR 2 zone:** +$663 USD/month | |
{: caption="Table 1. Pricing Scenarios" caption-side="top"}
{: #simpletabtable5}
{: tab-title="Pilot"}
{: tab-group="IAM-simple"}
