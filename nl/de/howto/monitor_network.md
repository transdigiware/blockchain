...
Rufen Sie den Network Monitor auf und öffnen Sie die Anzeige "Code installieren". Wenn aktiver Chaincode vorhanden ist, wird der Chaincode mit den zugehörigen Chaincode-IDs und Chaincode-Versionen in der Tabelle angezeigt. Wählen Sie einen Peer in der Dropdown-Liste aus, um den gesamten Chaincode für diesen Peer in der Tabelle anzuzeigen. Sie können die Protokolle des Chaincodes auf der [Registerkarte "Chaincode"](/docs/services/blockchain/howto/monitor_network.html#monitor-blockchain-network-monitor-channel-cc) Ihrer speziellen Anzeige "Kanal" anzeigen.
