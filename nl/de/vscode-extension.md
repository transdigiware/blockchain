...
*Abbildung 1. Typischer Smart-Contract-Entwicklungsablauf mit {{site.data.keyword.blockchainfull_notm}} Platform-Erweiterung für VS Code*  
...
- **Installation von Visual Studio Code**  
  Installieren Sie den [Visual Studio](https://code.visualstudio.com/)-Codeeditor.  
...
- **Voraussetzungen für Hyperledger Fabric-Version**  
  Diese Erweiterung ist mit Hyperledger Fabric Version 1.4.0 und höher kompatibel.  
...
3. Wählen Sie ein Asset aus, das anhand des Beispielvertrags verwaltet werden soll. Beispiel: ***bond***.
...
2. Klicken Sie in der Anzeige **Smart-Contract-Pakete** auf das Pluszeichen (**+**).
...
1. Klicken Sie im Teilfenster **Smart-Contract-Pakete** auf das Überlaufmenü und wählen Sie dann **Paket importieren** aus.
...
Sie können die Erweiterung auch verwenden, um eine Verbindung zu {{site.data.keyword.blockchainfull_notm}} Platform herzustellen und alle installierten und instanziierten Smart Contracts über die Benutzerschrittstelle der {{site.data.keyword.blockchainfull_notm}} Platform-Konsole aufzurufen.

Öffnen Sie die {{site.data.keyword.blockchainfull_notm}} Platform-Konsole, die Ihrer Instanz von {{site.data.keyword.blockchainfull_notm}} Platform zugeordnet ist. Navigieren Sie zur Registerkarte **Smart Contracts**. Verwenden Sie die Tabelle mit den **instanziierten Smart Contracts** auf der Registerkarte "Smart Contracts", um Ihr [Verbindungsprofil](/docs/services/blockchain/howto/ibp-console-create-app.html#ibp-console-app-profile) in das lokale Dateisystem herunterzuladen. Anschließend müssen Sie eine [Anwendungsidentität erstellen](/docs/services/blockchain/howto/ibp-console-create-app.html#ibp-console-app-identities). Verwenden Sie hierzu Ihre Zertifizierungsstelle und speichern Sie die Eintragungs-ID und den geheimen Schlüssel. Führen Sie die folgenden Schritte aus, um über Visual Studio Code eine Verbindung zu {{site.data.keyword.blockchainfull_notm}} Platform herzustellen.

1. Öffnen Sie die Registerkarte _{{site.data.keyword.blockchainfull_notm}} Platform_.
