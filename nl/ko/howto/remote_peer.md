...
- AWS 피어용 [Gossip](/docs/services/blockchain/glossary.html#glossary-gossip)은 현재 지원되지 않습니다. 즉, [개인용 데이터](https://hyperledger-fabric.readthedocs.io/en/release-1.2/private-data-arch.html){: external} 및 [서비스 발견](https://hyperledger-fabric.readthedocs.io/en/release-1.2/discovery-overview.html){: external}과 같은 gossip에 의존하는 Fabric 기능도 지원되지 않음을 의미합니다. 
