...
このガイドにより、{{site.data.keyword.blockchainfull}} Platform for {{site.data.keyword.cloud_notm}} の料金モデル、および Hyperledger Fabric v1.4.1 に基づくピア、順序付けプログラム、および認証局のコンポーネントのブロックチェーン・ネットワークを開発して拡大するときに生じる支払い金額を理解することができます。
{:shortdesc}
