...
- Para ver una guía de aprendizaje completa sobre el uso de una aplicación para interactuar con contratos inteligentes, consulte la [Guía de aprendizaje del documento comercial de Hyperledger Fabric](https://hyperledger-fabric.readthedocs.io/en/release-1.4/tutorial/commercial_paper.html){: external}.
...
5. En el panel **Seleccionar igual**, seleccione un igual en la lista desplegable que sea de una organización miembro del canal.
6. Si su contrato inteligente incluye recopilaciones de datos privados, debe actualizar el archivo JSON de configuración de recopilaciones asociado. De lo contrario, puede omitir este paso. Consulte este tema para obtener más información sobre cómo utilizar los [datos privados](/docs/services/blockchain/howto/ibp-console-smart-contracts.html#ibp-console-smart-contracts-private-data).
7. En el último panel se le solicitará que especifique la función de contrato inteligente que desea ejecutar cuando se inicie el contrato inteligente, junto con los argumentos asociados para pasar a dicha función.
...
- Vaya al separador **Contratos inteligentes** de la izquierda.
...
- Pulse el **menú de desbordamiento** en el lado derecho de la fila del contrato inteligente y pulse **Actualizar** para realizar los pasos siguientes:  
 ...
 3. En el panel **Seleccionar igual**, tiene que seleccionar un igual que pueda aprobar la propuesta para actualizar el contrato inteligente. Por lo tanto, tiene que seleccionar un igual en la lista desplegable de una organización que fuera miembro del canal antes de que creara una instancia del contrato inteligente en el canal.
...
4. ¿Qué ocurre si elimino una organización de mi recopilación de datos privados?
