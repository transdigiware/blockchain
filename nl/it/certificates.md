...
Puoi utilizzare questo pannello per registrare una nuova identità peer se stai distribuendo un [peer remoto](/docs/services/blockchain/howto?topic=blockchain-remote-peer-aws-about#remote-peer-aws-about). In alternativa, puoi registrare un client se stai sviluppando un'applicazione che può inviare transazioni alla tua rete.
...
[TLS (Transport Layer Security)](https://www.ibm.com/support/knowledgecenter/en/SSFKSJ_7.1.0/com.ibm.mq.doc/sy10660_.htm) è integrato nel modello di attendibilità di Hyperledger Fabric. Tutti i componenti in {{site.data.keyword.blockchainfull_notm}} Platform utilizzano TLS per autenticarsi e comunicare tra loro. Pertanto, devi allegare un certificato TLS emesso dalla piattaforma alle tue chiamate al fine di convalidare e crittografare la comunicazione. Gli altri certificati discussi in questa esercitazione proteggono la tua capacità di effettuare transazioni e gestire la rete. I certificati TLS vengono utilizzati per proteggere le chiamate alla rete.

I certificati TLS vengono emessi pubblicamente dalla piattaforma e sono gli stessi per tutti i componenti della rete. Puoi scaricare i certificati TLS dai seguenti link, a seconda del piano di adesione e dell'ubicazione del cloud. Puoi anche trovare i certificati TLS nel [profilo delle credenziali](/docs/services/blockchain?topic=blockchain-ibp-dashboard#ibp-dashboard-connection-profile). Questo certificato può risiedere ovunque, a condizione che tu possa farvi riferimento dalla tua applicazione o riga di comando.

- Certificato TLS per piano Starter
  - Stati Uniti: [us01.blockchain.ibm.com.cert](https://public-certs.us-south.ibm-blockchain-5-prod.cloud.ibm.com/us01.blockchain.ibm.com.cert){: external}; [us02.blockchain.ibm.com.cert](https://public-certs.us-south.ibm-blockchain-5-prod.cloud.ibm.com/us02.blockchain.ibm.com.cert){: external};
  ...
  - Regno Unito: [uk01.blockchain.ibm.com.cert](https://public-certs.us-south.ibm-blockchain-5-prod.cloud.ibm.com/uk01.blockchain.ibm.com.cert){: external}; [uk02.blockchain.ibm.com.cert](https://public-certs.us-south.ibm-blockchain-5-prod.cloud.ibm.com/uk02.blockchain.ibm.com.cert){: external};
...
- **cacerts** e **intermediatecerts**: puoi recuperare questi certificati con le [API Swagger](/docs/services/blockchain/howto?topic=blockchain-ibp-swagger#ibp-swagger) inviando una richiesta Get all'API MSP.
...
Per ulteriori informazioni sulla struttura degli MSP, vedi il documento relativo all'[adesione](https://hyperledger-fabric.readthedocs.io/en/release-1.2/membership/membership.html){: external} e quello relativo agli [MSP (Membership Service Provider)](https://hyperledger-fabric.readthedocs.io/en/release-1.2/msp.html){: external} nella documentazione di Hyperledger Fabric.

## Iscrizione e registrazione mediante il client CA Fabric
{: #managing-certificates-enroll-register-caclient}

Puoi anche utilizzare il client CA Fabric per generare certificati e registrare una nuova identità con la CA (Certificate Authority). Le istruzioni riportate di seguito generano certificati utilizzando la tua identità di amministratore, quindi utilizzano tali certificati per registrare un nuovo client. Per ulteriori informazioni sull'iscrizione utilizzando il client CA Fabric e la generazione dei certificati, vedi [MSP (Membership Services Provider)](/docs/services/blockchain?topic=blockchain-managing-certificates#managing-certificates-msp).
