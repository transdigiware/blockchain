...
- [Gossip](/docs/services/blockchain/glossary.html#glossary-gossip) per i peer AWS non è attualmente supportato. Ciò implica che non siano supportate neanche le funzioni Fabric che dipendono da gossip, come ad esempio i [dati privati](https://hyperledger-fabric.readthedocs.io/en/release-1.2/private-data-arch.html){: external} e il [rilevamento del servizio](https://hyperledger-fabric.readthedocs.io/en/release-1.2/discovery-overview.html){: external}.
