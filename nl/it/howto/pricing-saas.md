...
**Pronto per iniziare?** Consulta [Introduzione a {{site.data.keyword.blockchainfull_notm}} Platform](/docs/services/blockchain?topic=blockchain-get-started-ibp) per visualizzare le opzioni. 
