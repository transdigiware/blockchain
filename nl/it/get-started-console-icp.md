...
**Gruppi di destinatari**: questo argomento è pensato per gli amministratori del sistema che sono responsabili della distribuzione di {{site.data.keyword.blockchainfull_notm}} Platform on {{site.data.keyword.cloud_notm}} Private.
...
Puoi visitare [Configurazione di {{site.data.keyword.cloud_notm}} Private](/docs/services/blockchain?topic=blockchain-icp-console-setup#icp-console-setup) per suggerimenti e orientamenti.
...
- Quando sei pronti a iniziare a creare la tua rete, vedi i documenti relativi alle [considerazioni sull'alta disponibilità per i peer](/docs/services/blockchain?topic=blockchain-ibp-console-ha#ibp-console-ha-peers) e alle [considerazioni sull'alta disponibilità per i servizi di ordine](/docs/services/blockchain?topic=blockchain-ibp-console-ha#ibp-console-ha-ordering-service).
