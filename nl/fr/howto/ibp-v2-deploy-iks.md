...
![{{site.data.keyword.blockchainfull_notm}} Platform - Intégrations](../images/integrations-updated.png "{{site.data.keyword.cloud_notm}} - Intégrations")  
