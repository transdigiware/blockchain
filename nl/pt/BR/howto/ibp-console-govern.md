...
Conforme observamos em nossa seção em [Como o console interage com seu cluster do Kubernetes](/docs/services/blockchain/howto?topic=blockchain-ibp-console-govern#ibp-console-govern-iks-console-interaction), é recomendável usar os padrões para esses contêineres de peer e ajustá-los posteriormente quando se tornar evidente como eles estão sendo utilizados por seu caso de uso.
