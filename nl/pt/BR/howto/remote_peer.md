...
- Peers do [Gossip](/docs/services/blockchain/glossary.html#glossary-gossip) for AWS não são suportados atualmente. Isso implica que os recursos do Fabric que dependem do gossip, como os [dados privados](https://hyperledger-fabric.readthedocs.io/en/release-1.2/private-data-arch.html){: external} e a [descoberta de serviço](https://hyperledger-fabric.readthedocs.io/en/release-1.2/discovery-overview.html){: external}, também não são suportados.
