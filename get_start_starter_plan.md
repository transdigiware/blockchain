...
{{site.data.keyword.blockchainfull}} Platform Starter Plan offers you a pre-configured blockchain network with a single click. It provisions a permissioned network with the configuration of two [organizations](/docs/services/blockchain?topic=blockchain-glossary#glossary-organization), one [peer](/docs/services/blockchain?topic=blockchain-glossary#glossary-peer) per each organization, and one [channel](/docs/services/blockchain?topic=blockchain-glossary#glossary-channel) by default. After the network is created, you can scale and add more organizations and peers to your network. These networks are intended for novice users who are new to the {{site.data.keyword.blockchainfull_notm}} Platform.
{:shortdesc}
...
- [Create a Starter Plan network](/docs/services/blockchain?topic=blockchain-getting-started-with-starter-plan#getting-started-with-starter-plan-creating-a-network)
- [Invite organizations to your network](/docs/services/blockchain?topic=blockchain-getting-started-with-starter-plan#getting-started-with-starter-plan-inviting-members)
- [Joining a Starter Plan network](/docs/services/blockchain?topic=blockchain-getting-started-with-starter-plan#getting-started-with-starter-plan-joining-a-network)
...
- [Create channels](/docs/services/blockchain?topic=blockchain-getting-started-with-starter-plan#getting-started-with-starter-plan-create-channels)
...
- [Developing Chaincode](/docs/services/blockchain?topic=blockchain-getting-started-with-starter-plan#getting-started-with-starter-plan-develop-chaincode)
...
- [Monitoring network resources](/docs/services/blockchain?topic=blockchain-getting-started-with-starter-plan#getting-started-with-starter-plan-monitoring-resources)
- [Retrieving network credentials and connection profile](/docs/services/blockchain?topic=blockchain-getting-started-with-starter-plan#getting-started-with-starter-plan-retrieving-network-credentials)
- [Managing your network by using Swagger APIs](/docs/services/blockchain?topic=blockchain-getting-started-with-starter-plan#getting-started-with-starter-plan-swagger)
- [Resetting a network](/docs/services/blockchain?topic=blockchain-getting-started-with-starter-plan#getting-started-with-starter-plan-resetting-network)
- [Migrating from Starter Plan to Enterprise Plan](/docs/services/blockchain?topic=blockchain-getting-started-with-starter-plan#getting-started-with-starter-plan-migrate)
- [Deleting or leaving a network](/docs/services/blockchain?topic=blockchain-getting-started-with-starter-plan#getting-started-with-starter-plan-delete-network)


## Creating a network
{: #getting-started-with-starter-plan-creating-a-network}

You can get a Starter Plan [network](/docs/services/blockchain?topic=blockchain-glossary#glossary-network) with the default configuration immediately after you create an {{site.data.keyword.blockchainfull_notm}} Platform service instance.
...
You can invite other [organizations](/docs/services/blockchain?topic=blockchain-glossary#glossary-organization) to join your Starter Plan network as [members](/docs/services/blockchain?topic=blockchain-glossary#glossary-member) so that you can perform [transactions](/docs/services/blockchain?topic=blockchain-glossary#glossary-transaction) with each other. In addition, if you want to use Starter Plan for learning and testing purposes, you can simulate a multi-organization network by adding members for yourself to the network.
...
If you want to clean your customized configurations, running chaincode, or deployed applications, you can set your network back to the initial default configuration. For more information, see [Reset network](/docs/services/blockchain?topic=blockchain-ibp-dashboard#ibp-dashboard-reset-network).
