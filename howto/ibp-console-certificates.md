...
The default expiration period is the same for certificates that are generated by using the Fabric SDKs, the Fabric CA client, or by using the console. When certificates expire, nodes can no longer process transactions and your applications can no longer interact with your network. You need to enroll a new certificate for the identity, a process referred to as "certificate renewal". The following tables desribe the types of certificates that you need to manage, how to view their expiry date, and how to maintain them.
...
If the certificates were generated by using an external (third-party) CA, you need to [contact Support](/docs/blockchain?topic=blockchain-blockchain-support#blockchain-support-cases) to update your certificates for you.
{: important}
