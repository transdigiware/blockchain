...
| Certificate |	 Description |	How generated	| Default Expiration| How to view expiration	| How to renew| Update node admin | Update MSP | Update channel |	What to do if expired|
|-----|-----|-----|-----|-----|-----|-----|
| WIP  |  | |  |  || | | | | |
