...
- Kubernetes must be version 1.11, 1.12, or 1.13 in your {{site.data.keyword.cloud_notm}} Kubernetes cluster. You cannot deploy the {{site.data.keyword.blockchainfull_notm}} Platform to a cluster on version 1.14.
