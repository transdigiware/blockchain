...
4. Click the **Database selection** checkbox under **Advanced deployment options** and click **Next**. If your network is on {{site.data.keyword.cloud_notm}}, this option is only available on paid clusters.
